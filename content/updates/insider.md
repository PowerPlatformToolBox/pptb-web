...
- Auto-update: update notification always-on-top behavior removed.
- `pptb://` protocol is now only registered for packaged version of the app, preventing conflicts with development builds and allowing multiple versions to coexist without interference.
