            ...
            <Container className="relative">
                <FadeIn direction="up" delay={0.2}>
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        <h2 id="faq-title" className="font-display text-3xl tracking-tight text-slate-900 dark:text-slate-100 sm:text-4xl">
                            Frequently asked questions
                        </h2>
                        <p className="mt-4 text-lg tracking-tight text-slate-700 dark:text-slate-300">Can&apos;t find what you need? Head over to our GitHub Discussions — our community and team are there to help.</p>
                    </div>
                </FadeIn>
                <motion.ul
                    role="list"
                            ...
                            <ul role="list" className="flex flex-col gap-y-8">
                                {column.map((faq, faqIndex) => (
                                    <motion.li key={faqIndex} variants={staggerItem}>
                                        <h3 className="font-display text-lg/7 text-slate-900 dark:text-slate-100">{faq.question}</h3>
