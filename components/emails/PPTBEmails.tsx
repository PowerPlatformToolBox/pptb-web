...
const styles = {
    ...
    next: { backgroundColor: "#f8fafc", borderRadius: "6px", margin: "8px 0 0", padding: "20px" },
    nextHeading: { color: "#0f172a", fontSize: "18px", fontWeight: 700, lineHeight: "24px", margin: "0 0 6px" },
