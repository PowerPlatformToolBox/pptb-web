                    ...
                    <FadeIn direction="up" delay={0.1}>
                        <div className="mx-auto max-w-3xl">
                            ...
                            <p className="mx-auto mt-4 max-w-2xl text-base tracking-tight text-slate-700 sm:text-lg">
                                Power Platform ToolBox is free and open source, made possible by the generous support of our sponsors. Your sponsorship helps us maintain and improve the tools that
                                thousands of developers rely on every day.
                            </p>
                        ...
                        <FadeIn direction="up" delay={0.3}>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {sponsors.map((sponsor) => (
                                    <a key={sponsor.login} href={sponsor.githubUrl} target="_blank" rel="noopener noreferrer" className="card p-6 hover:shadow-fluent transition-shadow block">
