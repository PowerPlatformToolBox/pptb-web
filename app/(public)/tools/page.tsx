                        ...
                        <div className="mx-auto max-w-2xl lg:max-w-7xl">
                            <header className="max-w-2xl">
                                ...
                                <p className="mt-6 text-lg text-slate-700">
                                    Explore our collection of tools designed to supercharge your Power Platform development workflow.
                                </p>
                            </header>
                                    ...
                                    <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                                        {filteredTools.map((tool, index) => (
                                            <FadeIn key={tool.id} direction="up" delay={0.5 + index * 0.05}>
                                                <Link 
                                                    href={`/tools/${tool.id}`}
                                                    className="card group block h-full transition-all duration-300 hover:scale-105 hover:shadow-xl"
                                                >
                                                    <div className="p-6">
                            ...
                            <FadeIn direction="up" delay={0.6}>
                                <div className="mt-16 card-dark p-8 text-center">
                                    ...
                                    <p className="mt-4 text-slate-300">
                                        Join our community of developers and help build the next generation of Power Platform tools.
                                    </p>
                                    <div className="mt-6 flex flex-col sm:flex-row gap-4 justify-center">
                                        ...
                                        <Link 
                                            href="/auth/signin"
                                            className="btn-outline inline-flex items-center justify-center gap-2 bg-white"
                                        >
