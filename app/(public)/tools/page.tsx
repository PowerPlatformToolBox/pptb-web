                                            ...
                                            >
                                                <div className="p-6 flex flex-col h-full bg-white rounded-2xl">
                                                    ...
                                                    <div
                                                        ...
                                                        title={`${tool.downloads.toLocaleString()} downloads • ${tool.rating > 0 ? tool.rating.toFixed(1) : "N/A"} rating • ${tool.mau?.toLocaleString() || "0"} MAU`}
                                                    >
                                                        ...
                                                        <div className="flex items-center gap-1 text-amber-500">
                                                            ...
                                                            <span>{tool.rating > 0 ? tool.rating.toFixed(1) : "N/A"}</span>
                                                        </div>
