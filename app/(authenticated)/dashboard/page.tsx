                        ...
                        <div className="mx-auto max-w-2xl lg:max-w-7xl">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="mt-4 text-lg text-slate-700">
                                            Here&apos;s an overview of all available Power Platform tools with their analytics.
                                        </p>
                                    </div>
                                    <button
                            ...
                            <SlideIn direction="up" delay={0.3}>
                                <div className="grid grid-cols-1 gap-6 sm:grid-cols-3 mb-12">
                                    ...
                                    <div className="card p-6 bg-gradient-to-br from-amber-50 to-amber-100">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-2xl font-bold text-amber-900">
                                                    {(tools.reduce((sum, tool) => sum + tool.rating, 0) / tools.length).toFixed(1)}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
